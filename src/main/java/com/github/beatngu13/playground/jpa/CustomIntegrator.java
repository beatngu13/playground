...
/**
 * Based on {@link org.hibernate.envers.boot.internal.EnversIntegrator}.
 */
public class CustomIntegrator implements Integrator {

	private static final String AUTO_REGISTER = "hibernate.envers.autoRegisterListeners";
	...
	public void integrate(Metadata metadata, BootstrapContext bootstrapContext, SessionFactoryImplementor sessionFactory) {
		...
		if (!enversService.isEnabled()) {
			System.out.println("Skipping Envers listener registrations : EnversService disabled");
			return;
		}

		// Customization: ignore AUTO_REGISTER as this is definitely false.
		//		// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		...
		if (!enversService.getEntitiesConfigurations().hasAuditedEntities()) {
			System.out.println("Skipping Envers listener registrations : No audited entities found");
			return;
		}
		...
		if (enversService.getEntitiesConfigurations().hasAuditedEntities()) {
			...
			listenerRegistry.appendListeners(
					...
					new CustomEnversPostInsertEventListenerImpl(enversService)
			);
			listenerRegistry.appendListeners(
